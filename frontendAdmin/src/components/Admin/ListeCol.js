...
export default function ListeCol() {
	return (
		<div>
			<Menu />
			<Header />
										...
										<div className="card bg-light d-flex flex-fill">
												...
												<div className="row">
													<div className="col-7">
														...
														<p className="text-muted text-sm">
															<b>Profile: </b> Web Designer / UX / Graphic
														</p>
														<ul className="ml-4 mb-0 fa-ul text-muted">
															<li className="small">
																...
																Addresse: Demo City 04312, NJ
															</li>
															<li className="small">
																<span className="fa-li">
																	<i className="fas fa-lg fa-phone" />
																</span>{" "}
																Télephone : + 800 - 12 12 23 52
															</li>
														</ul>
													</div>
											...
											<div className="card-footer">
												<div className="text-right">
													<a href="2" className="btn btn-sm btn-danger">
														<i className="fas fa-pencil" /> Désactiver
													</a>
												</div>
											</div>
										</div>
